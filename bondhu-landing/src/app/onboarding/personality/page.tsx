...
import { calculatePersonalityScores, generateTraitInsights, determinePersonalityType } from "@/lib/personality-scoring"
...
export default function PersonalityQuestionnairePage() {
  ...
  const handleAssessmentComplete = async () => {
    ...
    try {
      ...
      // Determine personality type using the improved algorithm
      ...
      // Save to Supabase using the custom function (now includes personality type)
