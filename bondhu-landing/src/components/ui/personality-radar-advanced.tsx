...
export function PersonalityRadarAdvanced({ 
  ...
  const getPersonalityType = () => {
    ...
    // High-specificity types (70+ threshold for both traits)
    ...
    // Medium-specificity types (70+ threshold for single trait)
    if (openness > 70) return "The Creative Mind"
    if (conscientiousness > 70) return "The Organizer"
    if (extraversion > 70) return "The Energizer"
    if (agreeableness > 70) return "The Empath"
    
    // Balanced multi-trait types (55+ threshold for 3+ traits)
    if (openness > 55 && conscientiousness > 55 && extraversion > 55) return "The Renaissance Person"
