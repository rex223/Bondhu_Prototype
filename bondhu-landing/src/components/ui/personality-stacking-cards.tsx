  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`flex flex-col h-[80vh] sm:h-[85vh] w-[95%] sm:w-[90%] max-w-6xl rounded-2xl shadow-2xl overflow-hidden bg-background ${
          isActive && !canProceed ? 'ring-2 ring-orange-400 ring-opacity-50' : ''
        }`}
      >
        {/* Card Header */}
        <div className="p-4 sm:p-6 lg:p-8 border-b border-border/10">
          <div className="flex items-center justify-between gap-2">
            <div className="flex items-center space-x-3 sm:space-x-4 min-w-0">
              ...
              <div className="min-w-0">
                <h2 className='text-xl sm:text-2xl lg:text-3xl font-bold text-foreground truncate'>{cardData.title}</h2>
            ...
            <div className="text-right flex-shrink-0">
              <div className="text-xs sm:text-sm text-muted-foreground">Card {i + 1} of 6</div>
            </div>
          </div>
        </div>

        {/* Card Content */}
        <div className="flex-1 grid lg:grid-cols-2 min-h-0 overflow-hidden">
          {/* Left Panel - Content */}
          <div className="p-4 sm:p-6 lg:p-8 flex flex-col space-y-4 sm:space-y-6 overflow-y-auto">
            ...
            >
              ...
              <div className="absolute opacity-30">
                {cardData.type === 'intro' ? (
                  ...
                  <span className="text-8xl">{cardData.icon}</span>
                )}
              </div>
            </motion.div>
